...
export const CHECKLIST_PREVENTIVA: ChecklistItem[] = [
  ...
  { id: "P-010", descricao: "Verificar água acumulada no quadro de controle elétrico da torre", periodicidade: "Mensal", subsistema: "Torre Seca", referencia: "Manual §9.4.4" },
