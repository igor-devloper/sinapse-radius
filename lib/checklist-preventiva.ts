...
export const CHECKLIST_PREVENTIVA: ChecklistItem[] = [
  ...
  { id: "P-006", descricao: "Inspecionar/limpar aletas do trocador de calor (pistola de ar ou água)", periodicidade: "Mensal", subsistema: "Torre Seca", referencia: "Manual §9.4.2" },
  { id: "P-007", descricao: "Verificar ventiladores da torre seca (pás, ruídos, parafusos, terminais)", periodicidade: "Mensal", subsistema: "Torre Seca", referencia: "Manual §9.4.5" },
  { id: "P-008", descricao: "Lubrificar rolamentos do motor da bomba de circulação (graxa MOBIL UNIREX N2)", periodicidade: "2 meses", subsistema: "Estação de Bombas", referencia: "Manual §9.3.7" },
  { id: "P-009", descricao: "Termovisão nas conexões e quadros QCP", periodicidade: "2 meses", subsistema: "QCP — Quadro de Controle Principal", referencia: "Manual §9.4.4" },
  { id: "P-010", descricao: "Limpar filtro Y do duto de reposição da estação de bombas", periodicidade: "Semestral", subsistema: "Estação de Bombas", referencia: "Manual §9.3.1" },
  { id: "P-011", descricao: "Testar pH do fluido refrigerante (valor entre 7 e 9)", periodicidade: "Semestral", subsistema: "Estação de Bombas", referencia: "Manual §9.3.6" },
  { id: "P-012", descricao: "Inspecionar e reapertar terminais e bornes das conexões elétricas", periodicidade: "Mensal", subsistema: "Eletrica", referencia: "Manual §9.3.3" },
  { id: "P-013", descricao: "Inspecionar rede de tubulações quanto a vazamentos", periodicidade: "Semestral", subsistema: "Sistema de Manifold", referencia: "Manual §9.3.2" },
  { id: "P-014", descricao: "Rastrear e registrar parâmetros do fluido refrigerante (Tabela 9.1)", periodicidade: "Anual", subsistema: "Estação de Bombas", referencia: "Manual §9.3.6" },
  { id: "P-015", descricao: "Inspeção geral de todos os componentes e sistemas", periodicidade: "Anual", subsistema: "Geral", referencia: "Manual §9.4.6" },
  { id: "P-016", descricao: "Drenar e substituir fluido refrigerante do sistema (~1.500 L)", periodicidade: "A cada 1-2 anos", subsistema: "Estação de Bombas", referencia: "Manual §9.3.4" },
  // ── ASICs / Miners ──────────────────────────────────────────────────────────
  { id: "M-001", descricao: "Verificar status operacional de todos os miners (online/offline/falha) — identificar SN, posição no rack, tipo de falha e container", periodicidade: "Mensal", subsistema: "ASICs / Miners", referencia: "Checklist ASIC Mensal" },
];
